...
public class SortCommandTest {
    ...
    private List<ReadOnlyPerson> expectedSortedPersonList;
    ...
    public void setUp() throws Exception {
        ...
        expectedSortedPersonList = TestUtil.createList(janeDoe, johnDoe, samDoe);
    }
    ...
    public void sortCommand_correctlySorted() {
        ...
        assertEquals(expectedSortedPersonList, addressBook.getAllPersons().immutableListView());
    }
}
